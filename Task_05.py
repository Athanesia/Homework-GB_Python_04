...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("file05_1.txt", create_str(koef1))
write_file("file05_2.txt", create_str(koef2))

with open('file05_1.txt', 'r') as data:
    st1 = data.readlines()
with open('file05_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("file05_res.txt", create_str(lst_new))
with open('file05_res.txt', 'r') as data:
    st3 = data.readlines()
